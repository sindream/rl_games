...
class Runner:
    ...
    def __init__(self, algo_observer=None):
        ...
        ## wj added
        self.algo_factory.register_builder('a2c_continuous_privileged', lambda **kwargs : a2c_continuous.A2CAgentPrivil(**kwargs))
        self.algo_factory.register_builder('sac_privileged', lambda **kwargs : sac_agent.SACAgentPrivil(**kwargs))
        ...
        ## wj added
        self.player_factory.register_builder('a2c_continuous_privileged', lambda **kwargs : players.PpoPlayerContinuous(**kwargs))
        self.player_factory.register_builder('sac_privileged', lambda **kwargs : players.SACPlayer(**kwargs))
