...
class PpoPlayerContinuous(BasePlayer):
    ...
    def get_action(self, obs, is_deterministic = False):
        # print("get_action") #here
        if self.has_batch_dimension == False:
            # print("unsqueeze_obs") # False
        ...
        input_dict = {
            ...
            'estimate_state' : obs['estimate_state'],
            'reward' : obs['rewards'],

        }
        with torch.no_grad():
            res_dict = self.model(input_dict) ## error
        mu = res_dict['mus']
        ...
        if self.has_batch_dimension == False:
            # print("has_batch_dimension") # False
            current_action = torch.squeeze(current_action.detach())

        if self.clip_actions:
            # print("actions low", self.actions_low)
            # print("actions high", self.actions_high)
...
class SACPrivilPlayer(SACPlayer):
    
    def __init__(self, params):
        SACPlayer.__init__(self, params)