...
class NetworkBuilder:
    def __init__(self):
        ...
        # wj added
        self.network_factory.register_builder('actor_critic_privileged',
                                              lambda **kwargs: network_builder.A2CPrivilegedBuilder())
        ...
        self.network_factory.register_builder('central_value', lambda **kwargs: network_builder.CentralValueBuilder())
...
class ModelBuilder:
    def __init__(self):
        ...
        # wj added
        self.model_factory.register_builder('continuous_a2c_logstd_privileged',
                                            lambda network, **kwargs: models.ModelA2CContinuousLogStdPrivileged(network))
        ####
